...
<br>（战役或对抗（可能支持其他模式）允许在固定路程刷新 Boss，支持投票更改 Boss 刷新位置）
  ...
  * 注：插件编译有关的头文件传送门链接：<br>[TreeUtil.sp](https://github.com/GlowingTree880/L4D2_LittlePlugins/blob/main/Ai_HardSi/treeutil.sp)<br>[Colors.inc](https://github.com/GlowingTree880/L4D2_LittlePlugins/blob/main/TankStatusPanel/colors.inc)
